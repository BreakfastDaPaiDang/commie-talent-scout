...
正式首版定为 **v0.1.0**，见 [里程碑](https://github.com/BreakfastDaPaiDang/commie-talent-scout/milestone/1)。PRD 文档修订 1.6 包含标签、材料压缩、持久 MCP 接入与请求留存。正式应用已交付隔离测试环境的真实登录、首次改密、MCP 接入及基础调用留存，其他能力逐项实施，尚未生产上线。见 [开发说明](./docs/development.md)、[S1 验收](./docs/validation/v0.1.0-s1.md)与 [S2 验收](./docs/validation/v0.1.0-s2.md)。
