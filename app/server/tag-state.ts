...
export type TagBinding={tag_id:string;category_id:string;type:'person'|'org';category_name:string;category_description?:string;name:string;description:string;definition_version:number;category_version:number;color:string;enabled:number;category_enabled:number;deleted?:number;category_deleted?:number;merged_into:string|null;added_by:string;added_at:string;confirmed_by:string;confirmed_at:string;evidence:Evidence[];focus:number};
...
export const bindingJson=`json_object('tag_id',t.id,'category_id',c.id,'type',c.type,'category_name',c.name,'category_description',c.description,'name',t.name,'description',t.description,'definition_version',t.version,'category_version',c.version,'color',c.color,'enabled',t.enabled,'category_enabled',c.enabled,'deleted',t.deleted,'category_deleted',c.deleted,'merged_into',t.merged_into,'added_by',b.added_by,'added_at',b.added_at,'confirmed_by',b.confirmed_by,'confirmed_at',b.confirmed_at,'evidence',json(b.evidence_json),'focus',b.focus)`;
