...
app.post('/api/archives/delete',async c=>c.json(await new Archives(c.env,await authenticate(c.req.raw,c.env),'web').setDeleted(await c.req.json(),true)));
app.post('/api/archives/restore',async c=>c.json(await new Archives(c.env,await authenticate(c.req.raw,c.env),'web').setDeleted(await c.req.json(),false)));
