...
export function Icon({ name, size = 18, ...props }: React.SVGProps<SVGSVGElement>&{name:string;size?:number}) {
  const paths:Record<string,React.ReactNode> = {
    ...
    org: (
      <>
        <path d="M3 21V7l9-4v18M12 10h9v11M1 21h22M6 9h2M6 13h2M6 17h2M16 14h2M16 18h2" />
      </>
    ),
    bell: (
      <>
    ...
    settings: (
      <>
        <path d="m9 3-1 3-3 1v4l-2 1 2 3v3l4 1 2 2 3-2 4-1v-3l2-3-2-1V7l-3-1-1-3Z" />
    ...
    agent: (
      <>
        ...
        <path d="M12 3v4M2 11v5M22 11v5M8 16h8" />
    ...
    logout: (
      <>
        <path d="M9 3H3v18h6M10 12h12M17 7l5 5-5 5" />
      </>
    ),
    copy: (
      <>
