...
export function ScopeToolbar({scope,onScope,counts,filtersOpen,onFilters,activeFilters,filters,onReset,scopeItems=[['all','全部'],['mine','我负责'],['unread','有未读']]}:{scopeItems?:string[][];scope:string;onScope:(value:string)=>void;counts?:Record<string,number>;filtersOpen:boolean;onFilters:()=>void;activeFilters:boolean;filters:ReactNode;onReset?:()=>void}){
