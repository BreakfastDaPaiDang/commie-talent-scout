...
export type PickerMember={id:string;name:string;username?:string;frozen?:boolean;};

export function MemberPicker<T extends PickerMember>({
  members,
  value = [],
  onChange,
  label = "选择成员",
  ...
  disabled = false,
  renderAvatar,
}: {members:T[];value?:string[];onChange:(ids:string[])=>void;label?:string;multiple?:boolean;placeholder?:string;disabled?:boolean;renderAvatar?:(member:T)=>React.ReactNode}) {
